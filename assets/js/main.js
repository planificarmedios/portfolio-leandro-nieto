...
const themeTarget = document.getElementById("id-theme-color"); // 🎯 asegurate de que este id exista

// Crear gradiente de colores horizontal
const gradientH = ctx.createLinearGradient(0, 0, canvas.width, 0);
gradientH.addColorStop(0, "red");
gradientH.addColorStop(0.17, "yellow");
gradientH.addColorStop(0.33, "lime");
gradientH.addColorStop(0.5, "cyan");
gradientH.addColorStop(0.67, "blue");
...
// Crear gradiente vertical (blanco-arriba, transparente-medio, negro-abajo)
...
canvas.addEventListener("click", e => {
  ...
  // 🔹 Cambiar la variable CSS usada por el .portfolio-wrap
  themeTarget.style.setProperty('--dynamic-bg', color);
